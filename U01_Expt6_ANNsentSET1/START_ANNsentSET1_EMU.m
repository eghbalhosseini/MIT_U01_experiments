% Launcher script for MIT's ANN task - EMU version
...
cfg.PATH_TASK = 'C:\Users\Kermit\Desktop\MIT\Task_MIT_Fedorenko\U01_Expt6_ANNsentSET1';
cfg.PATH_SOURCEDATA = 'C:\Users\Kermit\Desktop\MIT\Data_ANN'; %rawdata root folder
cfg.SEND_TRIGGERS = 1;
...
cfg.TASK_FUNCTION = 'U01_Expt6_ANNsentSET1.m';
...
%% Confirmation prompt
prompt = {'Subject','Session','Run (1-4)'};
