...
cfg.PATH_TASK = ['U01_langloc_audio_vFeb2021'];
...
%% Task parameters 
cfg.TASK = 'langloc_audio'; % name of current task
cfg.TASK_FUNCTION = 'U01_langloc_audio_vFeb2021.m';
...
%% Confirmation prompt
prompt = {'Subject','Session','Run (1-3)'};
...
commandwindow
try
  U01_langloc_audio_vFeb2021(cfg);
catch e
