...
function [materials] = make_stimuli(materials, stimuli, audio_files, cond, probes_correct, probes_incorrect,num_trials_per_set,num_conds,num_sets)
    ...
    probe_incorrect = probes_incorrect(i,1);
        ...
        if(cond{i,1} == 'S')
            ...
            if(index <= num_stimuli_per_set)
                ...
                materials.(condition).s1_audio(index,:) = audio_files(i,1);
            ...
            if(index > num_stimuli_per_set && index <= num_stimuli_per_set*2)
                ...
                materials.(condition).s2_audio(index,:) = audio_files(i,1);
            ...
            if(index > num_stimuli_per_set*2 && index <= num_stimuli_per_set*3)
                ...
                materials.(condition).s3_audio(index,:) = audio_files(i,1);
            ...
            if(index > num_stimuli_per_set*3 && index <=num_stimuli_per_set*4)
                ...
                materials.practice.(condition).stim_audio(index,:) = audio_files(i,1);
